...
const Pages = () => {
  const LINKS = [
    ...
    { name: "Blog (coming soon!)", href: "#contact" },
  ];
...
const SocialLinks = () => {
  const LINKS = [
    { name: "/neilteje", icon: faGithub, href: "https://github.com/neilteje" },
    { name: "/in/neilteje", icon: faLinkedin, href: "https://linkedin.com/in/neilteje" },
    // { name: "neilteje@gmail.com", icon: faPaperPlane, href: "mailto:neilteje@gmail.com" },
  ];
  return (
