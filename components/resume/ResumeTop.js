...
const data = {
  email: ["nteje2@illinois.edu", "neilteje@gmail.com"],
  phone: ["(###) ###-####", "(469) 360-2509)"],
  github: ["/neilteje", "github.com/neilteje"],
  linkedin: ["/in/neilteje", "linkedin.com/in/neilteje"],
  ...
  return (
    <Box pt={6} px={2} textAlign={"center"}>
      ...
      <Flex justifyContent={"center"} mt={0.5}>
        ...
        <TextLink href={"https://github.com/neilteje"} onEdit={cycleData("github")} icon={faGithub}>
          {getValue("github")}
        </TextLink>
        <TextLink href={"https://linkedin.com/in/neilteje"} onEdit={cycleData("linkedin")} icon={faLinkedin}>
          {getValue("linkedin")}
        </TextLink>
      </Flex>
    </Box>
