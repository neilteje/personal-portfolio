    ...
    <Hide breakpoint={"print"}>
      ...
      <Flex bg={"rgba(0,0,0,0.2)"} width={"100%"} p={5} m={0} flexDir={"column"}>
        <Flex justifyContent={"center"} flexWrap={"wrap"} pb={5}>
          <Link m={2} href={"https://github.com/neilteje"} target={"_blank"}>
          ...
          <Link m={2} href={"https://linkedin.com/in/neilteje"} target={"_blank"}>
            <Flex m={2} alignItems={"center"}>
          ...
          <Link m={2} href={"mailto:neilteje@gmail.com"} target={"_blank"}>
            <Flex m={2} alignItems={"center"}>
              <HiMail size={"2em"} />
              <chakra.p ml={2} fontFamily={"Fira Code"}>
                neilteje@gmail.com
          ...
          <Link m={2} href={"mailto:nteje2@illinois.com"} target={"_blank"}>
            <Flex m={2} alignItems={"center"}>
              <HiMail size={"2em"} />
              <chakra.p ml={2} fontFamily={"Fira Code"}>
                nteje2@illinois.edu
        ...
        <Text textAlign={"center"} color={"gray.900"} fontSize={"sm"}>
          Portfolio made by Neil Teje | <Link href={"https://github.com/neilteje"}>Github</Link>
        </Text>
      </Flex>
    </Hide>
  );
